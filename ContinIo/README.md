...
Five project photos and the dashboard walkthrough are included below. See [the media guide](docs/MEDIA.md) to replace them.

### Hardware and check-in workflow
![ContinIo attendance terminal](media/images/05-device-overview.png)

| RFID check-in | Manual touchscreen entry |
| --- | --- |
| ![RFID check-in](media/images/RFID%20Checkin.png) | ![Manual entry](media/images/Manual%20Entry.png) |

| Successful check-in | Access denied |
| --- | --- |
| ![Confirmation](media/images/Checkin%20Confirmation.png) | ![Access denied](media/images/Access%20denied.png) |

[Watch the dashboard walkthrough](media/videos/Continio%20Dashboard.mp4)
...
docs/                            Setup, architecture, hardware and media guide
media/images/                    Add the five project photos here
media/videos/                    Add project recordings here
